...
public class ArrayList03<E> {
  ...
  public ArrayList03(int initialCapacity) {
  ...
  public void add(E e) {
    ...
    this.elementData[this.size++] = e; //배열을 늘린곳에 값을 넣어라..
  }
  ...
  public Object[] toArray() {    //object의 배열로 만든다
  ...
  @SuppressWarnings("unchecked")
  public E[] toArray(E[] arr) {      //E멤버의 배열로 만든다
