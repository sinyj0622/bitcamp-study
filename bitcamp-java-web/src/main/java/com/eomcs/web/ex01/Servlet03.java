...
public class Servlet03 extends HttpServlet {
  ...
  // HttpServlet의 service가 doget,doPost()를 호출하는것이다
  //
  ...
  // => 웹 브라우저
  //    => 톰캣 서버 
  //      => service(ServiceRequest, ServletResponse)
  //        => service(HttpServiceRequest, HttpServletResponse)
  //          => doGet(HttpServiceRequest, HttpServletResponse)
  @Override
