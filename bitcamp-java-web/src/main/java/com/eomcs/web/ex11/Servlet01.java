...
public class Servlet01 extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    // 세션 아이디를 보낸다.
    // 왜? 세션 아이디는 쿠키이다.
    // => 세션 아이디를 쿠키로 유효기간을 설정하지 않았기 때문에
    ...
    // => 생성한 세선의 ID는 쿠키를 통해 응답할때 웹 브라우져로 보낸다.
    // => HTTP 응답 프로토콜
    //
    // HTTP/1.1 200
    // Set-Cookie: JSESSIONID=0FF9B544DFC24D50D2B3CD8C7A311DED; Path=/bitcamp-java-web; HttpOnly
    // Content-Type: text/plain;charset=UTF-8
    // Content-Length: 45
    // Date: Wed, 08 Apr 2020 03:10:51 GMT
