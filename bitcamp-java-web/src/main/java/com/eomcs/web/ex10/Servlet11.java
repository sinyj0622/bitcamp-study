...
public class Servlet11 extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    // HTTP/1.1 200
    // Set-Cookie: v1=aaa
    // Set-Cookie: v2=bbb; Max-Age=30; Expires=Wed, 08-Apr-2020 02:41:45 GMT
    // Set-Cookie: v3=ccc; Max-Age=60; Expires=Wed, 08-Apr-2020 02:42:15 GMT
    // Content-Type: text/plain;charset=UTF-8
    // Content-Length: 37
    // Date: Wed, 08 Apr 2020 02:41:15 GMT
    // Keep-Alive: timeout=20
    // Connection: keep-alive

    // 유효기간을 설정하지 않으면 웹브라우저가 실행되는 동안에만 웹서버에게 쿠키를 보낸다.
    // => 웹 브라우저는 메모리에 쿠키를 보관한다. 브라우저 종료시 사라진다
