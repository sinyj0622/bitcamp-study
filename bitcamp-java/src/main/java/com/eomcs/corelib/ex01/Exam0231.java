...
public class Exam0231 {
  public static void main(String[] args) {
    ...
    // 오토 박싱이나 valueOf()로 생성한 Wrapper 객체는
    // constants pool에 오직 한 개만 생성되지 때문에
    ...
    // Integer 클래스가 오버라이딩한 equals()를 호출해야한다.
    System.out.println(obj3.equals(obj4));
    
    // 결론:
    // => wrapper 객체를 생성할 때는 new를 사용하지 말고,
    //    valueOf()나 오토박싱 기능을 이용하라
    // =>  그러면 값을 비교할때 == 연산자로 편하게 비교할수있다.
    //
    // 참고:
    // => wrapper 클래스는 모두 String 클래스처럼
    //    상속받은 Object에 equals()를 오버라이딩 하였다.
    // 즉 인스턴스를 비교하는것이 아니라 값이 같은지를 비교한다.
