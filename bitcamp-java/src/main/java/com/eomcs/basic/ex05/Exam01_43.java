...
public class Exam01_43 {
  public static void main(String[] args) {
    ...
    float r1 = f1 + f2;
    //f1과 f2에 들어있는 값이 유료자릿수라 하더라도 연산결과가 유효자리수가 아니라면 값이 깨진다
    ...
    // 짤린다.
    // 짤린 값이 r3와 r4에 저장된다.
    // float을 double 변수에 넣을때 왜곡이 발생하기 때문에 
    // 가능한 double변수로 값을 바꾼 다음에 연산을 수행하라
    // 더좋은걸은 처음부터 double변수를 사용!
    ...
    // 그럼에도 실제 출력해보면 맨 뒤에 극한의 작은수가 붙는다
    // 이유? 
    // IEEE 754의 이진수 변환 문제때문이다.
    // 어떻게 처리하나? 맨뒤의 극한의 작은수는 그냥 잘라버린다
  }
}
