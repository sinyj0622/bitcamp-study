...
public class Exam43 {
  public static void main(String[] args) {
   ...
   //(char)0xac00 == '가' 싱글코테이션
   //'문자' ==> 문자의 코드 값(0~65535) 을 리턴한다. // 문자에 ''를 붙이면!!! 코드 값 리턴!!!!!!!
   // 문자의 코드 값도 숫자로 다룰수있다
   ...
   System.out.println('각' + 1 ); // 문자에 ''를 붙이면!!! 코드 값 리턴!!!!!!! 연산이 가능하다
   System.out.println('각' - 1 ); 
   // 문자 코드에 정수 값을 연산하는 순간 
   // 그 결과는 문자코드가 아니라 일반적인 정수가 된다
   // 그래서 println은 그 값에 대한 문자를 출력하는것이 아니라 그냥 정수를 출력하는 것이다.
