...
public class Exam0540 {
  ...
  public static void main(String[] args) {
    ...
    // 파라미터 타입: byte ==> int
    Calculator1 c1 = MyCalculator::plus; // OK! //기존 존재하는 메서드를 재활용(인터페이스를 구현하지않고)사용하자

    // 파라미터 타입: short ==> int
    Calculator2 c2 = MyCalculator::plus; // OK!

    // 파라미터 타입: long ==> int
    // Calculator3 c3 = MyCalculator::plus; // 컴파일오류!

    // 파라미터 타입: float ==> int
    // Calculator4 c4 = MyCalculator::plus; // 컴파일오류!

    // 파라미터 타입: Object ==> int
    // Calculator5 c5 = MyCalculator::plus; // 컴파일오류!
    ...
    // 파라미터 타입: int, int ==> int
    // Calculator8 c8 = MyCalculator::plus; // 컴파일오류!

    // 파라미터 타입: int, int, int ==> int
    // Calculator c0 = MyCalculator::plus; // 컴파일오류!
