...
class Score2 {
  ...
  // 그래서 자바는 필드나 메서드의 '''외부 접근 범위'''를 조정하는 문법을 제공한다.
  ...
  // **외부에서 이 값들을 '조회'할 수 있는 방법/수단(method)**은 제공해야한다.
  // 보통 이렇게 필드의 값을 조회하는 용도로 사용하는 메서드의 경우
  // 메서드의 용도를 이해하기 쉽도록 getXxxx() 형태로 이름을 짓는다
  //  get필드명() {...}
  // => 메서드의 이름이 get으로 시작한다고해서 "게터(getter)"라고 부른다
...
public class Exam0210 {
  public static void main(String[] args) {
    ...
    // => 즉 클래스의 멤버만 접근할 수 있고 클래스의 외부에서는 접근 할 수 없다
