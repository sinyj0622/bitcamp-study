...
public class Exam0113 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 따라서 위 예제를 Linux,maxOS,Unix 의 CLI(Command Line Interface)
        // 에서 실행하면 정상적으로 한글 문자열이 출력되지만
        // window에서 실행하면 한글 문자열이 깨진다
        // 이유? **인코딩의 문제다**
        // => Linux,maxOS,Unix 가 기본으로 사용하는 문자 코드표를 UTF-8이다
        // => windows가 기본으로 사용하는 문자 코드표는 MS949이다
        
        // 그런데 이클립스에서 실행하면 깨지지 않는 이유?
        // => 이클립스에서 JVM을 실행할때 입출력 기본 인코딩을 UTF-8로 설정하기 떄문이다
        //
        ...
        // 파워쉘에서는 -Dfile.encoding=UTF-8 옵션을 제대로 처리하지 못한다
        // 도트(.)를 분리 문자로 인식한다
        //
