...
public class Exam0210 {
  public static void main(String[] args) throws Exception {
    ...
    // => 유닉스, 리눅스 계열 OS는 우선 순위를 고려한다.
    // .. 그래서 이런 OS에서 실행할 때는 우선 순위에 영향을 받을 것 이다.
    //
    // 주의!!!!!!!!!!
    // => Java 의 캐치프라이즈가 "Write Once, Run Anywhere!!!!!!!!!!!" 이다.
    // => 즉 OS에 상관없이 동일하게 동작하게 만드는것이 자바의 목적이다.
